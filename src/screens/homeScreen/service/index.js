              ...
              <div className="home-banner-left-content">
                ...
                <div className="mt-5 box-cart-container position-relative">
                  ...
                  {cartWarranty.map((item, index) => {
                    return (
                      <>
                        <div className="box-cart-content-container"
                        ...
                        <div className="split-ac-flex-left">
                          <div className="position-relative">
                            ...
                            <Button
                              ...
                              onClick={()=>navigate(Screens.serviceCart)}
                            >
                              {item.button}
                            </Button>
                          </div>
            ...
            <Col lg={{ span: 6 }}>
              ...
              >
                <ul className="px-0 mb-0">
                  <li className="company-user-training-offer">
                    ...
                    <span className="">
                      <img src={Images.ArrowDown} className="img-fluid" />
                    </span>
                  </li>
                </ul>
              </div>
